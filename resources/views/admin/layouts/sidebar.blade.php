<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                @php $avatar = auth()->user()->profileimage; @endphp
                <img alt="image" src="{{ asset($avatar) }}" class="rounded-circle mr-1">
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">KOLEJ TEKNOLOGI MAJU</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <img src="{{ asset('uploads/logo_ktm.jpeg') }}" alt="Logo" height="40" width="40"></a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ route('admin.dashboard') }}"><i class="fas fa-fire"></i>
                                <span>General Dashboard</span></a></li>
            ...
            {{-- {{ route('admin.student') }} --}}
            <li><a class="nav-link" href="{{ route('admin.student') }}"><i class="fas fa-user-graduate"></i> <span>Student Registration</span></a>
            </li>
{{-- {{ route('admin.examination') }} --}}
            <li><a class="nav-link" href="{{ route('admin.exams.index') }}"><i class="fas fa-th"></i><span>Examination Detail</span></a>
            </li>

            <li><a class="nav-link" href="{{ route('admin.notes.index') }}"><i class="far fa-file-alt"></i> <span>Notes</span></a></li>
