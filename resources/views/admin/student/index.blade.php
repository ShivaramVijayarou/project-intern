            ...
            <div class="col-12 d-flex justify-content-end">
                ...
                <form action="{{ route('admin.students.index') }}" method="GET" class="d-flex">
                    ...
                    <div class="input-group">
                        ...
                        <!-- Search by Name / IC -->
                        <input type="text" name="search" class="form-control" placeholder="Search by Name or IC"
                            value="{{ request('search') }}">

                        <!-- Search by Batch Code -->
                        <input type="text" name="batch_code" class="form-control" placeholder="Search by Batch Code"
                        ...
                        <tbody>
                            @forelse ($students as $student)
                                <tr>
                                    ...
                                    <td>{{ $student->level }}</td>
                                    <td>{{ $student->ic }}</td>
                                    <td>{{ optional($student->start_date)->format('d M Y') ?? '-' }}</td>
                                    <td>{{ optional($student->end_date)->format('d M Y') ?? '-' }}</td>
